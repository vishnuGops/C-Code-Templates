...
// The value of the element cannot be modified once it is added to
// the set, though it is possible to remove and add the modified value
// of that element.
